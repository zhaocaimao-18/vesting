...
- [💰 ERC20 线性释放（Vesting）合约开发实战模板](#-erc20-线性释放vesting合约开发实战模板)
  ...
  - [🧠 1. 项目背景与目标](#-1-项目背景与目标)
    - [Token分发为什么需要Vesting以及本项目要解决的问题是什么？](#token分发为什么需要vesting以及本项目要解决的问题是什么)
    - [项目整体架构图 todo](#项目整体架构图-todo)
...
## 🧠 1. 项目背景与目标
### Token分发为什么需要Vesting以及本项目要解决的问题是什么？
在 Web3 项目中，常见的合作关系往往包含甲方（资方）与乙方（开发方或顾问）。甲方希望激励乙方持续为项目贡献价值，而不是“一次性拿钱走人”；乙方则担心努力工作后拿不到报酬。于是，Vesting（线性释放）机制就应运而生，它解决了以下几个核心问题：
